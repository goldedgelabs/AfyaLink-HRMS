...
export const AuthProvider = ({ children }) => {
  ...
  const logout = async () => {
    try {
      await fetch(`import.meta.env.VITE_API_URL}'}/api/auth/logout', { method: 'POST', headers: {'Content-Type':'application/json'} });
    } catch (e) {}
  ...
  const refresh = async () => {
    try {
      const res = await fetch(`import.meta.env.VITE_API_URL}'}/api/auth/refresh', { method: 'POST', headers: {'Content-Type':'application/json'} });
